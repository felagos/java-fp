...
public class MatchListMain {
    ...
    public static void main(String[] args) {
        var courses = List.of(
            ...
            new Course("Python Programming", "Programming", 4, 80),
            new Course("Web Development", "Development", 5, 120),
            new Course("Data Science", "Data", 5, 150),
            new Course("Machine Learning", "Data", 5, 200),
        ...
        boolean hasAllCoursesHigherThan150 = courses.stream().allMatch(course -> course.numberOfStudents() > 150);
